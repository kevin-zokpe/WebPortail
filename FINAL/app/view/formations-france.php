...
<div id="main-content" class="section-content">
    <div class="container">
        <div class="row">
            <div class="col-md-offset-2 col-md-8">Les étudiants Français que vous trouverez sur Webportal sont ici de prestigieuses universités Françaises. <br/>Ici sont détaillés l'ensemble des cours dispensés à vos futurs stagiaires Français !</div><br /><br />
            <div class="col-md-offset-2 col-md-8" style="margin-bottom:50px;margin-top:30px;"><h3>IUT Cherbourg Manche - <a href="http://iutcherbourgmanche.unicaen.fr/d-u-t-/" target="_blank"> Diplômes Universitaires de Technologie</a></h3></div>
            ...
            <div class="col-xs-6 col-md-4">
                <a href="http://iutcherbourgmanche.unicaen.fr/d-u-t-/gte-energie-environnement-/" target="_blank" class="thumbnail">
                    <div class="caption">
                        <h3>Génie Thermique et Énergie<br/>-</h3>
                    </div>
                </a>
            </div>
