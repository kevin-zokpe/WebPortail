      ...
      <div class="container">
          <div class="row">
              <div class="col-md-12">
                  ...
                  <p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la
                  confiance dans l'économie numérique, il est précisé aux utilisateurs du
                  site WebPortail l'identité des différents intervenants dans le cadre
                  de sa réalisation et de son suivi :</p>
                  <p><strong>Propriétaires</strong> : L'équipe de WebJuice dont l'adresse
                  postale est <b><i>120 Rue de l'Exode, 50000 Saint-Lô</i></b><br>
                  <strong>Créateur</strong> : l'équipe de l'agence WebJuice.<br>
                  <strong>Hébergeur</strong> : Les fichiers sont hébergés sur le serveur de
                  <b>l'IUT de Cherbourg Manche, antenne de Saint-Lô</b>, dont l'adresse
                  est<br>
                  <b>120 Rue de l'Exode, 50000 Saint-Lô</b><br></p>
                  <h3>2. CONDITIONS GÉNÉRALES D'UTILISATION DU SITE ET DES SERVICES
                  PROPOSÉS.</h3>
                  <p>L’utilisation du site WebPortail implique l’acceptation pleine et entière des
                  ...
                  moment, les utilisateurs du site WebPortail sont donc invités à les consulter de manière
                  régulière.</p>
                  <p>Ce site est normalement accessible à tout moment aux utilisateurs. Une
                  interruption pour raison de maintenance technique peut être toutefois
                  décidée par l'équipe de WebJuice, qui s’efforcera alors de communiquer
                  préalablement aux utilisateurs les dates et heures de l’intervention.</p>
                  <p>Le site WebPortail est mis à jour régulièrement par Aymeric Picot et
                  Florian Bidel. De la même façon, les mentions légales peuvent être
                  ...
                  <p>Le site WebPortail a pour objet de fournir une information concernant
                  l’ensemble des activités de la société.</p>
                  <p>L'équipe de WebJuice s’efforce de fournir sur le site WebPortail des informations aussi précises que possible.
                  ...
                  informations.</p>
                  <p>Tous les informations indiquées sur le site WebPortail sont données à titre indicatif, et sont susceptibles
                  d’évoluer. Par ailleurs, les renseignements figurant sur le site WebPortail ne sont pas exhaustifs. Ils sont donnés sous réserve
                  ...
                  <h3>5. PROPRIÉTÉ INTELLECTUELLE ET CONTREFACONS.</h3>
                  <p>L'équipe de WebJuice est propriétaire des droits de propriété
                  ...
                  <p>L'équipe de WebJuice ne pourra être tenue responsable des dommages
                  directs et indirects causés au matériel de l’utilisateur, lors de l’accès
                  au site WebPortail, et résultant soit de l’utilisation d’un
                  ...
                  <p>L'équipe de WebJuice ne pourra également être tenue responsable des
                  dommages indirects (tels par exemple qu’une perte de marché ou perte d’une
                  chance) consécutifs à l’utilisation du site WebPortail.</p>
                  <p>Des espaces interactifs (possibilité de poser des questions dans
                  l’espace contact) sont à la disposition des utilisateurs. L'équipe de
                  WebJuice se réserve le droit de supprimer, sans mise en demeure
                  ...
                  à la protection des données. Le cas échéant, l'équipe de WebJuice se
                  ...
                  <h3>7. GESTIONS DES DONNÉES PERSONNELLES.</h3>
                  <p>En France, les données personnelles sont notamment protégées par la loi
                  n° 78-87 du 6 janvier 1978, la loi n° 2004-801 du 6 août 2004, l'article L.
                  226-13 du Code pénal et la Directive Européenne du 24 octobre 1995.</p>
                  <p>A l'occasion de l'utilisation du site WebPortail, peuvent êtres recueillies : l'URL des liens par
                  l'intermédiaire desquels l'utilisateur a accédé au site WebPortail, le fournisseur d'accès de l'utilisateur, l'adresse
                  de protocole Internet (IP) de l'utilisateur.</p>
                  <p>En tout état de cause l'équipe de WebJuice ne collecte des
                  informations personnelles relatives à l'utilisateur que pour le besoin de
                  certains services proposés par le site WebPortail. L'utilisateur fournit ces informations en toute
                  connaissance de cause, notamment lorsqu'il procède par lui-même à leur
                  saisie. Il est alors précisé à l'utilisateur du site WebPortail l’obligation ou non de fournir ces informations.</p>
                  ...
                  <p>Aucune information personnelle de l'utilisateur du site WebPortail n'est publiée à l'insu de l'utilisateur, échangée,
                  transférée, cédée ou vendue sur un support quelconque à des tiers. Seule
                  l'hypothèse du rachat de l'équipe de WebJuice et de ses droits
                  ...
                  modification des données vis à vis de l'utilisateur du site WebPortail.</p>
                  ...
                  <p>Le site WebPortail contient un certain nombre de liens hypertextes vers
                  d’autres sites, mis en place avec l’autorisation de l'équipe de WebJuice.
                  Cependant, l'équipe de WebJuice n’a pas la possibilité de vérifier le
                  contenu des sites ainsi visités, et n’assumera en conséquence aucune
                  responsabilité de ce fait.</p>
                  <p>La navigation sur le site WebPortail est susceptible de provoquer l’installation de
                  ...
                  qui enregistre des informations relatives à la navigation d’un ordinateur
                  ...
                  bouton Firefox, puis aller dans l'onglet Options. Cliquer sur l'onglet Vie
                  privée. Paramétrez les Règles de conservation sur : utiliser les paramètres
                  personnalisés pour l'historique. Enfin décochez-la pour désactiver les
                  cookies.</p>
                  <p>Sous Safari : Cliquez en haut à droite du navigateur sur le pictogramme
                  ...
                  les cookies.</p>
                  <p>Sous Chrome : Cliquez en haut à droite du navigateur sur le pictogramme
                  de menu (symbolisé par trois lignes horizontales). Sélectionnez Paramètres.
                  ...
                  <p>Tout litige en relation avec l’utilisation du site WebPortail est soumis au droit français. Il est fait
